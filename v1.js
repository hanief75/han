...
const User = [
	...
	},
	{
		type:'input',
		name:'target',
		message:'Masukin Username Target Kamu (Tanpa @[at])',
		validate: function(value){
			if(!value) return 'Can\'t Empty';
			return true;
		}
	},
	{
		type:'input',
		name:'text',
		message:'Masukin Teks Komen Kamu (Gunakan Pemisah [|] bila lebih dari 1)',
		validate: function(value){
			if(!value) return 'Can\'t Empty';
			return true;
		}
	},
	{
		type:'input',
		name:'sleep',
		message:'Masukin Waktu Kamu (Dalam hitungan MiliSeconds)',
		validate: function(value){
...
{bold cuman ngedit kata katanya doang w mah}
`);
